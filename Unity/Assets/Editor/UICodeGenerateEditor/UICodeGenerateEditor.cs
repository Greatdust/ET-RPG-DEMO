...
public class UICodeGeneratetor
{
    ...
    private static string nameSpace_Hotfix = "ETHotfix";
    private static string nameSpace_Model = "ETModel";
    ...
    [MenuItem("自动化工具/生成UI模块View层代码_ETHotfix")]
    ...
    [MenuItem("自动化工具/生成UI模块View层代码_ETModel")]
    public static void Gen_Model()
    {
        GameObject go = Selection.activeGameObject;
        outputPath = Application.dataPath + "/Model/UI/" + go.name;
        if (go != null)
        {
