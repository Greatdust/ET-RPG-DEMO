...
{
	[ObjectSystem]
	public class EmitObjUnitComponentSystem : AwakeSystem<EmitObjUnitComponent>
	{
		public override void Awake(EmitObjUnitComponent self)
		{
			self.Awake();
		}
	}
	
	public class EmitObjUnitComponent: Component
	{
		public static EmitObjUnitComponent Instance { get; private set; }
