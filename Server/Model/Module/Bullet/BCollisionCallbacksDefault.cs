...
namespace BulletUnity
{
    public class BCollisionCallbacksDefault : BCollisionCallbacks
    {
        ...
        public override void Start()
        {
            ...
            BCollisionObject co = GetParent<Unit>().GetComponent<BCollisionObject>();
            if (co == null)
            {
                Log.Error("BCollisionCallbacksDefault must be attached to an object with a BCollisionObject.");
                return;
            }
